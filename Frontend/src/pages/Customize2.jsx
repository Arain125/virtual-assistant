...
function Customize2() {
  ...
  return (
    <div className='w-full h-[100vh] bg-gradient-to-t from-[black] to-[#020236] flex items-center justify-center flex-col relative '>
       <FaArrowLeft className='absolute top-[30px] left-[25px] text-white cursor-pointer w-[25px] h-[25px]' onClick={()=>navigate("/customize") }/>
